...
class getProvinciaControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/ProvinciaController.php';

        $container->services['App\\Controller\\ProvinciaController'] = $instance = new \App\Controller\ProvinciaController();

        $instance->setContainer(($container->privates['.service_locator.jIxfAsi'] ?? $container->load('get_ServiceLocator_JIxfAsiService'))->withContext('App\\Controller\\ProvinciaController', $container));

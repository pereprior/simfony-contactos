...
class __TwigTemplate_9b2a5e2a69b4c2c18ddebe945d4d407f extends Template
{
...
";
    ...
    public function block_ea_fileupload_widget(array $context, array $blocks = []): iterable
    {
        ...
        yield "
                ";
        // line 749
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 749, $this->source); })()), "file", [], "any", false, false, false, 749), 'label', ["label_attr" => ["class" => "custom-file-label"]] + (twig_test_empty($_label_ = (isset($context["placeholder"]) || array_key_exists("placeholder", $context) ? $context["placeholder"] : (function () { throw new RuntimeError('Variable "placeholder" does not exist.', 749, $this->source); })())) ? [] : ["label" => $_label_]));
        yield "
            </div>
...
{% endblock %}
", "@EasyAdmin/crud/form_theme.html.twig", "/home/pprior/PhpstormProjects/simfony-usuarios/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/form_theme.html.twig");
    }
}

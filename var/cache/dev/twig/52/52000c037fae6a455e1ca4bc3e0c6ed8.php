...
class __TwigTemplate_acc785408a4abc6125da99574c27de35 extends Template
{
...
if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
    Sfjs = (function() {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 292
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 292, $this->source); })()));
            yield "))) {
                        var method = 'GET';
            ...
            yield "')) {
                        path = url.slice(";
            // line 340
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 340, $this->source); })()), "schemeAndHttpHost", [], "any", false, false, false, 340) . CoreExtension::getAttribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 340, $this->source); })()), "basePath", [], "any", false, false, false, 340))), "html", null, true);
            yield ");
                    }

                    if (!path.match(new RegExp(";
            // line 343
            yield json_encode((isset($context["excluded_ajax_paths"]) || array_key_exists("excluded_ajax_paths", $context) ? $context["excluded_ajax_paths"] : (function () { throw new RuntimeError('Variable "excluded_ajax_paths" does not exist.', 343, $this->source); })()));
            yield "))) {
                        var stackElement = {
                            error: false,
                            url: url,
...
";
    ...
    {
        return array (  617 => 539,  501 => 426,  445 => 372,  413 => 343,  407 => 340,  403 => 339,  397 => 336,  393 => 335,  347 => 292,  326 => 273,  324 => 272,  57 => 7,  48 => 3,);
    }
...
/*]]>*/</script>
", "@WebProfiler/Profiler/base_js.html.twig", "/home/pprior/PhpstormProjects/symfony-contactos3/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/base_js.html.twig");
    }
}
